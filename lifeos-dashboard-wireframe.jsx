...
/* ══════════════════════════════════════
   LifeOS Dashboard — Full Wireframe
...
const TASKS = [
  ...
  { t: "Push LifeOS dashboard to GitHub", tag: "Project", done: false, pri: "high" },
...
const VAULT_FILES = [
  ...
  { name: "lifeos-architecture.md", folder: "04-Projects", mod: "Today 3:00 PM", size: "12.1 KB" },
        ...
        <div style={{ padding: 24, maxWidth: 900 }}>
          ...
          <div style={{ background: "#111218", borderRadius: 10, border: "1px solid #1a1b20", overflow: "hidden", marginBottom: 20 }}>
            ...
            {[
              ...
              { time: "11:00", block: "Push LifeOS dashboard to GitHub", type: "project" },
    ...
    <div style={S.root}>
      ...
      <div style={S.side}>
        ...
        <div style={{ padding: sideCollapsed ? "14px 0" : "14px 14px", display: "flex", alignItems: "center", gap: 10, justifyContent: sideCollapsed ? "center" : "flex-start", borderBottom: "1px solid #1a1b20", cursor: "pointer" }} onClick={() => setSideCollapsed(v => !v)}>
          ...
          {!sideCollapsed && <span style={{ fontSize: 14, fontWeight: 700, color: "#fafafa", letterSpacing: -.3 }}>LifeOS</span>}
        </div>
